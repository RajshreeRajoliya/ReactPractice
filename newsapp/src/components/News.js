...
fetchMoreData = async() => {
  ...
  let url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=3a19b8c483974d43b468a4d35151d252&page=1&pageSize=${this.props.pageSize}`
